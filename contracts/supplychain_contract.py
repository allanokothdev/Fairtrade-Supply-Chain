...
class Stage:
    ...
    def application_creation(self):
        return Seq([
            ...
            Assert(Txn.note() == Bytes("fairtrade-supplychain:uv1")),
            ...
            App.globalPut(self.Variables.timestamp, Txn.application_args[3]),
            App.globalPut(self.Variables.attachment, Txn.application_args[4]),
            Approve()
        ])
